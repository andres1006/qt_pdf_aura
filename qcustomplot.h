...
class QCP_LIB_DECL QCPItemRect : public QCPAbstractItem
{
  ...
  Q_PROPERTY(QPen selectedPen READ selectedPen WRITE setSelectedPen)
    Q_PROPERTY(QBrush brush READ brush WRITE setBrush)
    Q_PROPERTY(QBrush bBrush READ bBrush WRITE setBBrush)
  Q_PROPERTY(QBrush selectedBrush READ selectedBrush WRITE setSelectedBrush)
    //Erik
    Q_PROPERTY(int index READ index WRITE setIndex)
    Q_PROPERTY(bool valid READ valid WRITE setValid)
    Q_PROPERTY(QCPAxis* plotXAxis READ plotXAxis WRITE setPlotXAxis)
    Q_PROPERTY(QCPAxis* plotYAxis READ plotYAxis WRITE setPlotYAxis)
  /// \endcond
public:
  ...
  QPen selectedPen() const { return mSelectedPen; }
  QBrush brush() const { return mBrush; }
  QBrush bBrush() const { return m_bBrush; }
  QBrush selectedBrush() const { return mSelectedBrush; }
  //Erik
  int index() const { return m_index; }
  bool valid() const { return m_valid; }
  QCPAxis* plotXAxis() const {return m_plotXAxis;}
  QCPAxis* plotYAxis() const {return m_plotXAxis;}

  // setters;
  void setPen(const QPen &pen);
  void setSelectedPen(const QPen &pen);
  void setBrush(const QBrush &brush);
  void setBBrush(const QBrush &bbrush);
  void setSelectedBrush(const QBrush &brush);
  //Erik
  void setIndex(const int &index);
  void setValid(const bool &valid);
  void setEditing(const bool &valid);
  void setPlotXAxis(QCPAxis *value);
  void setPlotYAxis(QCPAxis *value);
  ...
  //Erik
  QCPItemPosition * const m_zoomTopLeft;
  QCPItemPosition * const m_zoomBottomRight;
...
signals:
  void saccadeSelected(QPointF, QPointF, int);
  void overSaccadeMovement(int);
...
class QCP_LIB_DECL QCPItemTracer : public QCPAbstractItem
{
  ...
  Q_PROPERTY(double graphKey READ graphKey WRITE setGraphKey)
    ...
    Q_PROPERTY(QCPAxis* plotXAxis READ plotXAxis WRITE setPlotXAxis)
    Q_PROPERTY(QCPAxis* plotYAxis READ plotYAxis WRITE setPlotYAxis)
    Q_PROPERTY(double lastKey READ lastKey WRITE setLastKey)
    Q_PROPERTY(double plotSize READ plotSize WRITE setPlotSize)
  /// \endcond
public:
  /*!
  ...
  */
  ...
  QCPAxis* plotXAxis() const {return m_plotXAxis;}
  QCPAxis* plotYAxis() const {return m_plotXAxis;}
  double lastKey() const {return m_lastKey;}
  double plotSize() const {return m_plotSize;}
  int id() const {return m_id;}
  bool settingValue(){return m_settingValue;}
  ...
  void setPlotXAxis(QCPAxis *value);
  void setPlotYAxis(QCPAxis *value);
  void setLastKey(double value);
  void setPlotSize(double value);
  void setId(int value);
  void setXYScaleFactor(double xValue, double yValue, bool init);
  void setSettingValue(bool value, int type);
...
signals:
        void moveMe(int,int,int);
        void dotCatched(int, int, int);
        void dotReleased(QPoint, int);
        void overSomeTracer(bool);
